These notes are for the EDITORS of clao
...
Make sure you have an ID range in the [idranges file](clao-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [clao-edit.owl](clao-edit.owl)

** DO NOT EDIT clao.obo OR clao.owl in the top level directory **

[../../clao.owl](../../clao.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/luis-gonzalez-m/Collembola) for details.
 ...
 * [clao-idranges.owl](clao-idranges.owl)
...
This generates derived files such as clao.owl and clao.obo and places
 ...
 * https://github.com/luis-gonzalez-m/Collembola/releases
 * https://github.com/luis-gonzalez-m/Collembola/releases/new
...
what is in the `owl:versionIRI` of the derived clao.owl (`data-version` in
clao.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/clao.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/clao/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/luis-gonzalez-m/Collembola.svg?branch=master)](https://travis-ci.org/luis-gonzalez-m/Collembola)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/luis-gonzalez-m](https://travis-ci.org/profile/luis-gonzalez-m)
 2. click the "Sync account" button
 3. Click the tick symbol next to Collembola
